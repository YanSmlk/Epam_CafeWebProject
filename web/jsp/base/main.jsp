...
<head>
    ...
    <fmt:message bundle="${local}" key="page.title.main" var="title" />
    ...
    <fmt:message bundle="${local}" key="page.main.welcome" var="welcome" />
    <fmt:message bundle="${local}" key="page.main.text" var="text" />
    <title>${title}</title>
...
<form action="FrontController" method="post">
    ...
    <c:set var="lastPage" value="/jsp/base/main.jsp" scope="session" />
...
<nav class="navbar navbar-inverse">
    ...
    <div class="container">
        ...
        <div class="media">
            <img src="images/main.jpeg" class="img-rounded" style="width:1140px" style="height:200px">
        </div>
    </div>
