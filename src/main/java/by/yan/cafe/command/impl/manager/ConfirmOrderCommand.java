...
public class ConfirmOrderCommand implements Command
{
    ...
    public ConfirmOrderCommand(OrderControlAction orderControlAction)
    {
    ...
    public Router execute(HttpServletRequest request)
    {
        ...
        try
        {
            orderControlAction.confirmOrder(OrderStatus.Finished, Integer.parseInt(orderId),orderPrice,clientName);
        }
